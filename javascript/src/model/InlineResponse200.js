...
import EmailSubscriptionjsonldEmailSubscriptionDetail from './EmailSubscriptionjsonldEmailSubscriptionDetail';
...
export default class InlineResponse200 {
    ...
    * @class
    * @param hydramember {Array.<module:model/EmailSubscriptionjsonldEmailSubscriptionDetail>} 
    */
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('hydra:member')) {
                obj['hydra:member'] = ApiClient.convertToType(data['hydra:member'], [EmailSubscriptionjsonldEmailSubscriptionDetail]);
            }
    ...
    /**
    * @member {Array.<module:model/EmailSubscriptionjsonldEmailSubscriptionDetail>} hydra:member
    */

...
import StudentProfileUserjsonldStudentProfileUserList from './StudentProfileUserjsonldStudentProfileUserList';
...
export default class InlineResponse20011 {
    ...
    * @class
    * @param hydramember {Array.<module:model/StudentProfileUserjsonldStudentProfileUserList>} 
    */
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('hydra:member')) {
                obj['hydra:member'] = ApiClient.convertToType(data['hydra:member'], [StudentProfileUserjsonldStudentProfileUserList]);
            }
    ...
    /**
    * @member {Array.<module:model/StudentProfileUserjsonldStudentProfileUserList>} hydra:member
    */

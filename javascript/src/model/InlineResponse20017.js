...
import TeachingClassTeacherInvitationjsonldTeachingClassTeacherInvitationList from './TeachingClassTeacherInvitationjsonldTeachingClassTeacherInvitationList';
...
export default class InlineResponse20017 {
    ...
    * @class
    * @param hydramember {Array.<module:model/TeachingClassTeacherInvitationjsonldTeachingClassTeacherInvitationList>} 
    */
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('hydra:member')) {
                obj['hydra:member'] = ApiClient.convertToType(data['hydra:member'], [TeachingClassTeacherInvitationjsonldTeachingClassTeacherInvitationList]);
            }
    ...
    /**
    * @member {Array.<module:model/TeachingClassTeacherInvitationjsonldTeachingClassTeacherInvitationList>} hydra:member
    */

...
import StudentjsonldStudentList from './StudentjsonldStudentList';
...
export default class InlineResponse20013 {
    ...
    * @class
    * @param hydramember {Array.<module:model/StudentjsonldStudentList>} 
    */
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('hydra:member')) {
                obj['hydra:member'] = ApiClient.convertToType(data['hydra:member'], [StudentjsonldStudentList]);
            }
    ...
    /**
    * @member {Array.<module:model/StudentjsonldStudentList>} hydra:member
    */

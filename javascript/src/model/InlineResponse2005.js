...
import ParentUserjsonldParentUserDetail from './ParentUserjsonldParentUserDetail';
...
export default class InlineResponse2005 {
    ...
    * @class
    * @param hydramember {Array.<module:model/ParentUserjsonldParentUserDetail>} 
    */
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('hydra:member')) {
                obj['hydra:member'] = ApiClient.convertToType(data['hydra:member'], [ParentUserjsonldParentUserDetail]);
            }
    ...
    /**
    * @member {Array.<module:model/ParentUserjsonldParentUserDetail>} hydra:member
    */

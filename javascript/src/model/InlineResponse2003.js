...
import NotificationjsonldNotificationList from './NotificationjsonldNotificationList';
...
export default class InlineResponse2003 {
    ...
    * @class
    * @param hydramember {Array.<module:model/NotificationjsonldNotificationList>} 
    */
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('hydra:member')) {
                obj['hydra:member'] = ApiClient.convertToType(data['hydra:member'], [NotificationjsonldNotificationList]);
            }
    ...
    /**
    * @member {Array.<module:model/NotificationjsonldNotificationList>} hydra:member
    */

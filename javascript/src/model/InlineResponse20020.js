...
import UserjsonldTeacherDetail from './UserjsonldTeacherDetail';
...
export default class InlineResponse20020 {
    ...
    * @class
    * @param hydramember {Array.<module:model/UserjsonldTeacherDetail>} 
    */
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('hydra:member')) {
                obj['hydra:member'] = ApiClient.convertToType(data['hydra:member'], [UserjsonldTeacherDetail]);
            }
    ...
    /**
    * @member {Array.<module:model/UserjsonldTeacherDetail>} hydra:member
    */

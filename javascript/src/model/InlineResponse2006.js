...
import RatingMediajsonldRatingMediaList from './RatingMediajsonldRatingMediaList';
...
export default class InlineResponse2006 {
    ...
    * @class
    * @param hydramember {Array.<module:model/RatingMediajsonldRatingMediaList>} 
    */
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('hydra:member')) {
                obj['hydra:member'] = ApiClient.convertToType(data['hydra:member'], [RatingMediajsonldRatingMediaList]);
            }
    ...
    /**
    * @member {Array.<module:model/RatingMediajsonldRatingMediaList>} hydra:member
    */

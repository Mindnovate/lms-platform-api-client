...
import TeachingClassTeacherjsonldTeachingClassTeacherList from './TeachingClassTeacherjsonldTeachingClassTeacherList';
...
export default class InlineResponse20018 {
    ...
    * @class
    * @param hydramember {Array.<module:model/TeachingClassTeacherjsonldTeachingClassTeacherList>} 
    */
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('hydra:member')) {
                obj['hydra:member'] = ApiClient.convertToType(data['hydra:member'], [TeachingClassTeacherjsonldTeachingClassTeacherList]);
            }
    ...
    /**
    * @member {Array.<module:model/TeachingClassTeacherjsonldTeachingClassTeacherList>} hydra:member
    */

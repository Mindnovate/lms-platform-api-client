...
import TeacherjsonldTeacherDetail from './TeacherjsonldTeacherDetail';
...
export default class InlineResponse20014 {
    ...
    * @class
    * @param hydramember {Array.<module:model/TeacherjsonldTeacherDetail>} 
    */
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('hydra:member')) {
                obj['hydra:member'] = ApiClient.convertToType(data['hydra:member'], [TeacherjsonldTeacherDetail]);
            }
    ...
    /**
    * @member {Array.<module:model/TeacherjsonldTeacherDetail>} hydra:member
    */

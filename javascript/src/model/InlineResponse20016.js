...
import TeachingClassStudentjsonldTeachingClassStudentList from './TeachingClassStudentjsonldTeachingClassStudentList';
...
export default class InlineResponse20016 {
    ...
    * @class
    * @param hydramember {Array.<module:model/TeachingClassStudentjsonldTeachingClassStudentList>} 
    */
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('hydra:member')) {
                obj['hydra:member'] = ApiClient.convertToType(data['hydra:member'], [TeachingClassStudentjsonldTeachingClassStudentList]);
            }
    ...
    /**
    * @member {Array.<module:model/TeachingClassStudentjsonldTeachingClassStudentList>} hydra:member
    */

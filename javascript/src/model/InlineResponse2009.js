...
import SchooljsonldSchoolList from './SchooljsonldSchoolList';
...
export default class InlineResponse2009 {
    ...
    * @class
    * @param hydramember {Array.<module:model/SchooljsonldSchoolList>} 
    */
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('hydra:member')) {
                obj['hydra:member'] = ApiClient.convertToType(data['hydra:member'], [SchooljsonldSchoolList]);
            }
    ...
    /**
    * @member {Array.<module:model/SchooljsonldSchoolList>} hydra:member
    */

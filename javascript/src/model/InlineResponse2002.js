...
import MediajsonldMediaList from './MediajsonldMediaList';
...
export default class InlineResponse2002 {
    ...
    * @class
    * @param hydramember {Array.<module:model/MediajsonldMediaList>} 
    */
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('hydra:member')) {
                obj['hydra:member'] = ApiClient.convertToType(data['hydra:member'], [MediajsonldMediaList]);
            }
    ...
    /**
    * @member {Array.<module:model/MediajsonldMediaList>} hydra:member
    */

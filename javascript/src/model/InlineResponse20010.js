...
import StudentProfileUserInvitationjsonldStudentProfileUserInvitationList from './StudentProfileUserInvitationjsonldStudentProfileUserInvitationList';
...
export default class InlineResponse20010 {
    ...
    * @class
    * @param hydramember {Array.<module:model/StudentProfileUserInvitationjsonldStudentProfileUserInvitationList>} 
    */
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('hydra:member')) {
                obj['hydra:member'] = ApiClient.convertToType(data['hydra:member'], [StudentProfileUserInvitationjsonldStudentProfileUserInvitationList]);
            }
    ...
    /**
    * @member {Array.<module:model/StudentProfileUserInvitationjsonldStudentProfileUserInvitationList>} hydra:member
    */

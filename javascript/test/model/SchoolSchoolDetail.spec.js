...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StarfishLabzApi.SchoolSchoolDetail();
  });
  ...
  describe('SchoolSchoolDetail', function() {
    it('should create an instance of SchoolSchoolDetail', function() {
      // uncomment below and update the code to test SchoolSchoolDetail
      //var instane = new StarfishLabzApi.SchoolSchoolDetail();
      //expect(instance).to.be.a(StarfishLabzApi.SchoolSchoolDetail);
    });

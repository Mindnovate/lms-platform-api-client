...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StarfishLabzApi.RatingjsonldRatingList();
  });
  ...
  describe('RatingjsonldRatingList', function() {
    it('should create an instance of RatingjsonldRatingList', function() {
      // uncomment below and update the code to test RatingjsonldRatingList
      //var instane = new StarfishLabzApi.RatingjsonldRatingList();
      //expect(instance).to.be.a(StarfishLabzApi.RatingjsonldRatingList);
    });

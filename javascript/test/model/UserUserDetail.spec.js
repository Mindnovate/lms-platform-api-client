...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StarfishLabzApi.UserUserDetail();
  });
  ...
  describe('UserUserDetail', function() {
    it('should create an instance of UserUserDetail', function() {
      // uncomment below and update the code to test UserUserDetail
      //var instane = new StarfishLabzApi.UserUserDetail();
      //expect(instance).to.be.a(StarfishLabzApi.UserUserDetail);
    });

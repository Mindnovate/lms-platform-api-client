...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StarfishLabzApi.SchoolSchoolList();
  });
  ...
  describe('SchoolSchoolList', function() {
    it('should create an instance of SchoolSchoolList', function() {
      // uncomment below and update the code to test SchoolSchoolList
      //var instane = new StarfishLabzApi.SchoolSchoolList();
      //expect(instance).to.be.a(StarfishLabzApi.SchoolSchoolList);
    });

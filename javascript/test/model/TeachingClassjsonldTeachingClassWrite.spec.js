...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StarfishLabzApi.TeachingClassjsonldTeachingClassWrite();
  });
  ...
  describe('TeachingClassjsonldTeachingClassWrite', function() {
    it('should create an instance of TeachingClassjsonldTeachingClassWrite', function() {
      // uncomment below and update the code to test TeachingClassjsonldTeachingClassWrite
      //var instane = new StarfishLabzApi.TeachingClassjsonldTeachingClassWrite();
      //expect(instance).to.be.a(StarfishLabzApi.TeachingClassjsonldTeachingClassWrite);
    });

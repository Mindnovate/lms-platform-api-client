...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StarfishLabzApi.NotificationjsonldNotificationDetail();
  });
  ...
  describe('NotificationjsonldNotificationDetail', function() {
    it('should create an instance of NotificationjsonldNotificationDetail', function() {
      // uncomment below and update the code to test NotificationjsonldNotificationDetail
      //var instane = new StarfishLabzApi.NotificationjsonldNotificationDetail();
      //expect(instance).to.be.a(StarfishLabzApi.NotificationjsonldNotificationDetail);
    });

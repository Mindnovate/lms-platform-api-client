...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StarfishLabzApi.NotificationjsonldNotificationList();
  });
  ...
  describe('NotificationjsonldNotificationList', function() {
    it('should create an instance of NotificationjsonldNotificationList', function() {
      // uncomment below and update the code to test NotificationjsonldNotificationList
      //var instane = new StarfishLabzApi.NotificationjsonldNotificationList();
      //expect(instance).to.be.a(StarfishLabzApi.NotificationjsonldNotificationList);
    });

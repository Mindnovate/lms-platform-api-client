...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StarfishLabzApi.RatingjsonldRatingDetail();
  });
  ...
  describe('RatingjsonldRatingDetail', function() {
    it('should create an instance of RatingjsonldRatingDetail', function() {
      // uncomment below and update the code to test RatingjsonldRatingDetail
      //var instane = new StarfishLabzApi.RatingjsonldRatingDetail();
      //expect(instance).to.be.a(StarfishLabzApi.RatingjsonldRatingDetail);
    });

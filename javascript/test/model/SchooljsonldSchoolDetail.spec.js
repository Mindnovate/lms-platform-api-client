...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StarfishLabzApi.SchooljsonldSchoolDetail();
  });
  ...
  describe('SchooljsonldSchoolDetail', function() {
    it('should create an instance of SchooljsonldSchoolDetail', function() {
      // uncomment below and update the code to test SchooljsonldSchoolDetail
      //var instane = new StarfishLabzApi.SchooljsonldSchoolDetail();
      //expect(instance).to.be.a(StarfishLabzApi.SchooljsonldSchoolDetail);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StarfishLabzApi.RatingjsonldRatingWrite();
  });
  ...
  describe('RatingjsonldRatingWrite', function() {
    it('should create an instance of RatingjsonldRatingWrite', function() {
      // uncomment below and update the code to test RatingjsonldRatingWrite
      //var instane = new StarfishLabzApi.RatingjsonldRatingWrite();
      //expect(instance).to.be.a(StarfishLabzApi.RatingjsonldRatingWrite);
    });

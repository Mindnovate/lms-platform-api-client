...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StarfishLabzApi.NotificationNotificationList();
  });
  ...
  describe('NotificationNotificationList', function() {
    it('should create an instance of NotificationNotificationList', function() {
      // uncomment below and update the code to test NotificationNotificationList
      //var instane = new StarfishLabzApi.NotificationNotificationList();
      //expect(instance).to.be.a(StarfishLabzApi.NotificationNotificationList);
    });

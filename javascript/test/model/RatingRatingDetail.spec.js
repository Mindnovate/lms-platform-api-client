...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StarfishLabzApi.RatingRatingDetail();
  });
  ...
  describe('RatingRatingDetail', function() {
    it('should create an instance of RatingRatingDetail', function() {
      // uncomment below and update the code to test RatingRatingDetail
      //var instane = new StarfishLabzApi.RatingRatingDetail();
      //expect(instance).to.be.a(StarfishLabzApi.RatingRatingDetail);
    });

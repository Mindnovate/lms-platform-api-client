...
class NotificationApi {
  ...
  Future<InlineResponse2003> getNotificationCollection({ int page, int itemsPerPage }) async {
    ...
    String path = "/api/auth/v1/notifications".replaceAll("{format}","json");
  ...
  Future<Notification:jsonldNotificationDetail> getNotificationItem(String id) async {
    ...
    // create path and map variables
    String path = "/api/auth/v1/notification/{id}".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
    ...
    if(response.statusCode >= 400) {
      ...
      return
          apiClient.deserialize(response.body, 'Notification:jsonldNotificationDetail') as Notification:jsonldNotificationDetail ;
    } else {
      return null;
    }
  }

...
class InlineResponse2006 {
  ...
  List<RatingMedia:jsonldRatingMediaList> hydra:member = [];
  ...
  @override
  String toString() {
    return 'InlineResponse2006[hydra:member=$hydra:member, hydra:totalItems=$hydra:totalItems, hydra:view=$hydra:view, hydra:search=$hydra:search, ]';
  }

  InlineResponse2006.fromJson(Map<String, dynamic> json) {
    if (json == null) return;
    hydra:member = RatingMedia:jsonldRatingMediaList.listFromJson(json['hydra:member']);

...
class InlineResponse2004 {
  ...
  List<OtherUser:jsonldOtherUserDetail> hydra:member = [];
  ...
  @override
  String toString() {
    return 'InlineResponse2004[hydra:member=$hydra:member, hydra:totalItems=$hydra:totalItems, hydra:view=$hydra:view, hydra:search=$hydra:search, ]';
  }

  InlineResponse2004.fromJson(Map<String, dynamic> json) {
    if (json == null) return;
    hydra:member = OtherUser:jsonldOtherUserDetail.listFromJson(json['hydra:member']);

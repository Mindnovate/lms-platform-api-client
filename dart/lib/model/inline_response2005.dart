...
class InlineResponse2005 {
  ...
  List<ParentUser:jsonldParentUserDetail> hydra:member = [];
  ...
  @override
  String toString() {
    return 'InlineResponse2005[hydra:member=$hydra:member, hydra:totalItems=$hydra:totalItems, hydra:view=$hydra:view, hydra:search=$hydra:search, ]';
  }

  InlineResponse2005.fromJson(Map<String, dynamic> json) {
    if (json == null) return;
    hydra:member = ParentUser:jsonldParentUserDetail.listFromJson(json['hydra:member']);

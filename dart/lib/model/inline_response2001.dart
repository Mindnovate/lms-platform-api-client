...
class InlineResponse2001 {
  ...
  List<LearningSkill:jsonldLearningSkillList> hydra:member = [];
  ...
  @override
  String toString() {
    return 'InlineResponse2001[hydra:member=$hydra:member, hydra:totalItems=$hydra:totalItems, hydra:view=$hydra:view, hydra:search=$hydra:search, ]';
  }

  InlineResponse2001.fromJson(Map<String, dynamic> json) {
    if (json == null) return;
    hydra:member = LearningSkill:jsonldLearningSkillList.listFromJson(json['hydra:member']);
